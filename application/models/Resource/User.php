<?php
class Application_Model_Resource_User extends Dm_Model_Resource_Db_Table_Abstract implements Application_Model_Resource_User_Interface 
{
    protected $_name = 'user';
    protected $_primary = 'userId';
    protected $_rowClass = 'Application_Model_Resource_User_Item';
